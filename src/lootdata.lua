...
if mod.IsZag then game.OverwriteTableKeys(mod.newLootData, {
    SisyphusBossRush =
    {
        ...
        OnUsedFunctionArgs = game._G[ZJ_guid].PresetEventArgs.SisyphusBenefitChoices,
        [_PLUGIN.guid .. "RemoveInputBlock"] = true,
    ...
    EurydiceBossRush =
    {
        ...
        OnUsedFunctionName = ZJ_guid .. "." .. "ModsNikkelMHadesBiomesBenefitChoice",
        OnUsedFunctionArgs = game._G[ZJ_guid].PresetEventArgs.EurydiceBenefitChoices,
        [_PLUGIN.guid .. "RemoveInputBlock"] = true,
        [_PLUGIN.guid .. "OnCloseFinishedFunctionName"] = ZJ_guid .. "." .. "ModsNikkelMHadesBiomesNPCPostChoicePresentation",
    },
    PatroclusBossRush =
    {
        ...
        OnUsedFunctionName = ZJ_guid .. "." .. "ModsNikkelMHadesBiomesBenefitChoice",
        OnUsedFunctionArgs = game._G[ZJ_guid].PresetEventArgs.PatroclusBenefitChoices,
        [_PLUGIN.guid .. "RemoveInputBlock"] = true,
        [_PLUGIN.guid .. "OnCloseFinishedFunctionName"] = ZJ_guid .. "." .. "ModsNikkelMHadesBiomesNPCPostChoicePresentation",
    },
    OrpheusBossRush =
    {
        ...
        OnUsedFunctionName = ZJ_guid .. "." .. "ModsNikkelMHadesBiomesBenefitChoice",
        OnUsedFunctionArgs = game._G[ZJ_guid].PresetEventArgs.OrpheusBenefitChoices,
        [_PLUGIN.guid .. "RemoveInputBlock"] = true,
        [_PLUGIN.guid .. "OnCloseFinishedFunctionName"] = ZJ_guid .. "." .. "ModsNikkelMHadesBiomesNPCPostChoicePresentation",
    }
})
